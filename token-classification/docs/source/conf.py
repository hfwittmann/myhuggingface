...
# token_classification documentation build
...
from token_classification import __version__ as release

# -- Project information -----------------------------------------------------

project = "token_classification"
author = "Kedro"
...
htmlhelp_basename = "token_classificationdoc"
...
latex_documents = [
    (
        master_doc,
        "token_classification.tex",
        "token_classification Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "token_classification",
        "Project token_classification codebase.",
        "Data-Science",
    )
]
